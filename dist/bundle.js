...
/***/ function(module, exports, __webpack_require__) {
	...
	var _paint_canvas = __webpack_require__(7);
	
	var _paint_canvas2 = _interopRequireDefault(_paint_canvas);
	
	var _game_drawer = __webpack_require__(8);
	...
	var _game_play = __webpack_require__(358);
	
	var _game_play2 = _interopRequireDefault(_game_play);
	
	var _game_over = __webpack_require__(364);
	...
	var preparedCanvas = new _paint_canvas2.default('game', { width: CANVAS_WIDTH, height: CANVAS_HEIGHT });
	var drawer = new _game_drawer2.default(preparedCanvas, UNIT);
	
	start();
	
	function start() {
	  (0, _menu2.default)({ drawer: drawer, done: startGamePlay });
	}
	
	function startGamePlay(data) {
	  (0, _game_play2.default)({ drawer: drawer, data: data, done: startGameOver });
	}
	
	function startGameOver(data) {
	  (0, _game_over2.default)({ drawer: drawer, data: data, done: start });
	}
	...
	var PaintCanvas = function () {
	  function PaintCanvas(domID) {
	    ...
	    var _options$width = options.width,
	        ...
	        height = _options$height === undefined ? dom.clientWidth : _options$height;
	  ...
	  _createClass(PaintCanvas, [{
	    ...
	    value: function clear() {
	      ...
	      var _canvasSize = this.canvasSize(),
	          _canvasSize2 = _slicedToArray(_canvasSize, 2),
	          canvasWidth = _canvasSize2[0],
	          canvasHeight = _canvasSize2[1];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var GameDrawer = function () {
	  ...
	  _createClass(GameDrawer, [{
	    ...
	    key: 'drawGameOver',
	    value: function drawGameOver(score) {
	      var highestScore = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 0;
...
/***/ function(module, exports, __webpack_require__) {
	...
	function menu(_ref) {
	  ...
	  var keyup$ = _Rx2.default.Observable.fromEvent(document, 'keyup').pluck('code').filter(function (code) {
	    return code === 'Space';
	  }).first();
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var Observable_1 = __webpack_require__(13);
	var bindCallback_1 = __webpack_require__(30);
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var BoundCallbackObservable_1 = __webpack_require__(31);
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var Observable_1 = __webpack_require__(13);
	var bindNodeCallback_1 = __webpack_require__(34);
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var BoundNodeCallbackObservable_1 = __webpack_require__(35);
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var Observable_1 = __webpack_require__(13);
	var shareReplay_1 = __webpack_require__(279);
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var Observable_1 = __webpack_require__(13);
	var skipLast_1 = __webpack_require__(285);
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(298).setImmediate, __webpack_require__(298).clearImmediate))
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _howler = __webpack_require__(359);
	
	var _game_rule = __webpack_require__(360);
	...
	function gamePlay(_ref) {
	  ...
	  var bgSound = new _howler.Howl({
	    src: [__webpack_require__(362)],
	    loop: true,
	    volume: 0.5
	  });
	
	  var eatingSound = new _howler.Howl({
	  ...
	  var pressArrowKey$ = _Rx2.default.Observable.fromEvent(document, 'keyup').pluck('code').filter(function (code) {
	    return VALID_ARROW_KEYS.indexOf(code) !== -1;
	  });
	
	  var snakeManualMove$ = pressArrowKey$.map(function (arrowKey) {
	  ...
	  var eatingEggSubject$ = new _Rx2.default.Subject();
	
	  var gameLevel$ = _Rx2.default.Observable.merge(frame$.sampleTime(1000).mapTo(1), eatingEggSubject$.mapTo(20)).scan(function (point, value) {
	    return point + value;
	  ...
	  var snakeAutoMove$ = frame$.withLatestFrom(snakeSpeed$).scan(function (_ref2, curr) {
	  ...
	  }, { count: 0, emit: false }).filter(function (_ref3) {
	    var emit = _ref3.emit;
	    return emit;
	  }).withLatestFrom(snakeManualMove$).map(function (v) {
	    return v[1];
	  });
	
	  var nextStep$ = _Rx2.default.Observable.merge(snakeManualMove$, snakeAutoMove$);
	
	  var initialWorld = (0, _game_rule.initWorld)(width, height);
	  var worldRunner$ = nextStep$.scan(function (world, step) {
	    if ((0, _game_rule.isCollideWithWall)(world.snake, width, height) || (0, _game_rule.isSnakeBiteItSelf)(world.snake)) {
	      var error = new Error('Game Over');
	      error.world = world;
	      throw error;
	    }
	
	    return (0, _game_rule.nextWorld)(world, step, width, height, {
	      onEatingEgg: function onEatingEgg() {
	        return eatingEggSubject$.next();
	      }
	    });
	  }, initialWorld);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.levelMapToSpeed = levelMapToSpeed;
	exports.nextEggs = nextEggs;
	exports.safeWorld = safeWorld;
	exports.nextWorld = nextWorld;
	exports.nextSnake = nextSnake;
	exports.getEatenEgg = getEatenEgg;
	exports.wholeSnake = wholeSnake;
	exports.isCollideWithWall = isCollideWithWall;
	exports.isSnakeBiteItSelf = isSnakeBiteItSelf;
	...
	var SPEED_LEVELS = [500, 400, 300, 250, 200, 150, 125, 100, 75, 50];
	
	function levelMapToSpeed(level) {
	  var speedLevel = level - 1;
	  if (speedLevel < 0) {
	    speedLevel = 0;
	...
	function nextEggs(eggs, deletedEgg, snake, worldWidth, worldHeight) {
	  return (0, _utils.replaceItem)(eggs, deletedEgg, randomEggWithout([].concat(_toConsumableArray(eggs), _toConsumableArray(wholeSnake(snake)))));
	  ...
	  function randomEggWithout() {
	    ...
	    while (!isValidPosition) {
	      result = [(0, _utils.randomInt)(0, worldWidth), (0, _utils.randomInt)(0, worldHeight)];
	...
	function safeWorld(snake, eggs, score) {
	  if (!(0, _utils.isObject)(snake)) throw new Error('snake is not a object');
	  if (!(0, _utils.isArray)(snake.head)) throw new Error('snake.head is not a array');
	  if (!(0, _utils.isArray)(snake.body)) throw new Error('snake.body is not a array');
	  if (!(0, _utils.isArray)(eggs)) throw new Error('eggs is not a array');
	  if (!(0, _utils.isInteger)(score)) throw new Error('score is not a integer');
	...
	function nextWorld(world, step, worldWidth, worldHeight, _ref) {
	  var onEatingEgg = _ref.onEatingEgg;
	
	  var eatenEgg = getEatenEgg(world.snake.head, world.eggs, step);
	
	  if (eatenEgg !== null) {
	    if (onEatingEgg) {
	      onEatingEgg();
	    }
	    return safeWorld(nextSnake(world.snake, step, true), nextEggs(world.eggs, eatenEgg, world.snake, worldWidth, worldHeight), world.score + SCORE_PER_EGG);
	  } else {
	    return safeWorld(nextSnake(world.snake, step), world.eggs, world.score);
	  }
	}
	
	function nextSnake(_ref2, step) {
	  var head = _ref2.head,
	      body = _ref2.body;
	  var keepTail = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : false;
	
	  var nextBody = keepTail ? body : body.slice(0, -1);
	  return {
	...
	function getEatenEgg(head, eggs, step) {
	  var eatenEggIndex = null;
	  var nextHead = [head[0] + step[0], head[1] + step[1]];
	...
	function isCollideWithWall(snake, worldWidth, worldHeight) {
	...
	function isSnakeBiteItSelf(snake) {
	  ...
	  return wholeSnake(snake).slice(1).some(function (_ref4) {
	...
	function initWorld(worldWidth, worldHeight) {
	  return safeWorld({
	  ...
	  function randomEggs(number) {
	    return (0, _utils.createArray)(number, function () {
	      return [(0, _utils.randomInt)(0, worldWidth), (0, _utils.randomInt)(0, worldHeight)];
	    });
	  }
	
	  function snakeBody(length) {
	    return (0, _utils.createArray)(length, function () {
	      return [0, 1];
	    });
	  }
	}
...
/***/ function(module, exports) {
	...
	function flow(funcs) {
	  ...
	  return function () {
	    var index = 0;
	    var result = funcs[index].apply(this, arguments);
	    while (++index < length) {
	...
	function createArray(arrLength, processser) {
	  var arr = [];
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__.p + "a0828afe077f28db011b43737e005e02.mp3";

/***/ },
/* 363 */
/***/ function(module, exports, __webpack_require__) {

	module.exports = __webpack_require__.p + "a163ac393ca8c1f58fa87904b2c8e193.mp3";
...
/***/ function(module, exports, __webpack_require__) {
	...
	function gameOver(_ref) {
	  ...
	  drawer.fadeOutThan(function () {
	    ...
	    var keyup$ = _Rx2.default.Observable.fromEvent(document, 'keyup').pluck('code').first();
